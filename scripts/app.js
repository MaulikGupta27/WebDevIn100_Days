  ...
  async loadProjects() {
    const projectsData = [
      ...
      },
      {
        originalDay: 57,
        name: "Age Calculator",
        description: "Calculates your age based on the input date compared to the current date.",
        demoLink: "./public/Day-57_AgeCalculator/index.html",
        category: "utilities",
        technologies: ["HTML", "CSS", "JavaScript"],
        features: ["Accurate Age Calculation", "User-Friendly Date Picker", "Real-Time Result Display"]
      },
      {
        originalDay: 54,
        name: "Rock Paper Scissors",
